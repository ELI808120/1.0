      ...
      >
        ...
        <div className="p-6 space-y-5 overflow-y-auto">
            ...
            <GuideStep 
                ...
                description={<p>גשו לתיקיית הפרויקט במחשב שלכם. נווטו לתיקייה <code className="bg-gray-200 p-1 rounded">src/data</code> ומחקו את הקובץ <code className="bg-gray-200 p-1 rounded">initialData.ts</code> הקיים. לאחר מכן, העבירו את הקובץ החדש שהורדתם לאותה התיקייה.</p>}
            />
            <GuideStep 
